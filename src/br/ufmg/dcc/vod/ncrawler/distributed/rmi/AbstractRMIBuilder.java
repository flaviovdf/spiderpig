 ...
 */
public abstract class AbstractRMIBuilder<T extends Remote> {
	...
	/**
	 * Creates a new builder which will bind objects at the RMI registry in the
	 * given port.
	 * 
	 * @param port Port to use
	 * @throws RemoteException If registry cannot be created / located.
	 */
	public AbstractRMIBuilder(int port) throws RemoteException {
		this.port = port;
